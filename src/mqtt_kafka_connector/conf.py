...
MQTT_FSTATE_SOURCE_MATCH = os.getenv("MQTT_FSTATE_SOURCE_MATCH") or error()
MQTT_FSTATE_SOURCE_TEMPLATE = os.getenv("MQTT_FSTATE_SOURCE_TEMPLATE") or error()
...
FSTATE_KAFKA_TOPIC = os.getenv("FSTATE_KAFKA_TOPIC", "fstate")
